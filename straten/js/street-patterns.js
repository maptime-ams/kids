      ...
      React.createElement("section", null, 
        React.createElement("div", {className: "container"}, 
          React.createElement("div", {className: "row"}, 
            React.createElement("h1", null, "Zoek een stratenpatroon!"), 
            React.createElement("p", null, "Met deze website kun je een mooi stratenpatroon zoeken, en deze met de lasersnijder in ons Fablab uit hout laten uitsnijden! Zoek bijvoorbeeld je eigen huis en de straten in de buurt, of een ander patroon dat je mooi vindt.")
          )
        ), 
        React.createElement("div", {className: "button-bottom"}, 
          React.createElement("button", {onClick: this.onButtonClick}, "OK, beginnen!")
        )
      )
    )
  },
  ...
  render: function() {
    return (
      React.createElement("section", null, 
        ...
        React.createElement("div", {className: "button-bottom"}, 
          React.createElement("button", {onClick: this.onButtonClick}, "Ja, deze wil ik (heb geduld, duurt even)!")
        ), 
        React.createElement("div", {className: "input-top"}, 
          React.createElement("input", {type: "search", placeholder: "Zoek je adres...", id: "step-map-geocode", onKeyUp: this.onGeocode})
        )
      )
    )
  },
  ...
  render: function() {
    return (
      React.createElement("section", null, 
        ...
        React.createElement("div", {className: "button-bottom"}, 
          React.createElement("button", {onClick: this.onButtonClick}, "Ja, ja, ja!")
        )
      )
    )
  },
  ...
  render: function() {
    ...
    return (
      React.createElement("section", null, 
        React.createElement("div", {className: "container"}, 
          React.createElement("div", {className: "row"}, 
            React.createElement("h2", null, "Klaar! Op naar de lasersnijder!"), 
